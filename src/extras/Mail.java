...
public class Mail{  
	...
	public static void main(String[] args) {	
		...
		files.add("./receipts/8ID.pdf");
		files.add("./receipts/9ID.pdf");
		files.add("./receipts/13ID.pdf");
//		mailWithAttachment("beatricebaldassarre86@gmail.com","lisistrata1998","chiara.passarelli97@gmail.com","Subject","./receipts/8ID.pdf");
		mailWithMultipleAttachment("beatricebaldassarre86@gmail.com","lisistrata1998","chiara.passarelli97@gmail.com","Subject",files);
	}
